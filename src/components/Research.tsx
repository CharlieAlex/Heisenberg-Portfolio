    ...
    <div className="projects-container" id="research">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href={process.env.PUBLIC_URL + "/paper/thesis.pdf"} target="_blank" rel="noreferrer"><img src={thesis} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href={process.env.PUBLIC_URL + "/paper/labor_final.pdf"} target="_blank" rel="noreferrer"><img src={trendTCE} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href={process.env.PUBLIC_URL + "/paper/applied_econ_final.pdf"} target="_blank" rel="noreferrer"><img src={laborDivision} className="zoom" alt="thumbnail" width="100%"/></a>
